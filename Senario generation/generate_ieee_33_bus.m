function [ieee_33,pole_num,line_num] = generate_ieee_33_bus(node_1_location, pole_interval)
    ...
    line_num = readmatrix(fileName,'Sheet',3,'Range','A3:C39');
    ...
    arclen = rad2deg(dist/earthRadius(distUnits)); 
    az = 90;    %east
    [ieee_33(26,1),ieee_33(26,2)] = reckon(ieee_33(6,1),ieee_33(6,2), arclen,az);
    for i = 26:32
        latIn = ieee_33(i,1);
        lonIn = ieee_33(i,2);
        dist = section_length(i); %meters
    ...
    %calculate pole number in each seaction
    pole_num = section_length / pole_interval;
    pole_num = floor(pole_num);
    pole_num = pole_num + 1;
end